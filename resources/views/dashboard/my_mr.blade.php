            ...
            @forelse($mr_lists->data as $info)
                <div class="list-group-item list-group-item-action flex-column align-items-start">
                    <div class="row">
                        ...
                        <div class="col-1">
                            <a target="_blank" href="{{url('mr-doctor/'.encrypt($info->mobile_no).'/'.$info->api_token)}}" class="btn btn-primary btn-sm mb-2">Doctor</a><br>
                            <a target="_blank" href="{{url('mr-assistant/'.encrypt($info->mobile_no).'/'.$info->api_token)}}" class="btn btn-warning btn-sm mb-2">Assistant</a><br>
                            <a target="_blank" href="{{url('mr-coupons-details/'.encrypt($info->mobile_no).'/'.$info->api_token)}}" class="btn btn-info btn-sm mb-2">Coupons</a><br>
                        </div>
                    </div>
                </div>
            @empty
